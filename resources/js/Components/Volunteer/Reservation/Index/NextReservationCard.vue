<template>
    <x-card>
        ...
        />
        <x-divider/>
        <inertia-link :href="route('volunteer.reservations.show', { id: reservation.id })" >
            <x-button>
                View More Details
            </x-button>
        </inertia-link>
...
import ReservationDetails from "@/Components/Volunteer/Reservation/ReservationDetails";
